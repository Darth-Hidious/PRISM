...
def build_full_registry(
    ...
    # NOTE: Advanced discovery tools are marketplace add-ons, not part of
    # core PRISM. Install them via the marketplace; they register themselves
    # via custom_loader (~/.prism/tools/).
