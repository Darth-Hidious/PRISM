...
TOOL_GRAPH = {
    ...
    # ── Property evaluation → downstream chains ─────────────────────
    "alpha_predict": {
...
LOGICAL_FORMS = [
    {
        ...
        "tool_sequence": [
            {"tool": "search_materials", "role": "primary",
             "reason": "Search existing databases for known and related materials"},
            {"tool": "alpha_predict", "role": "followup",
             "reason": "Evaluate and rank candidate compositions"},
        ],
    ...
    },
    {
        ...
        "tool_sequence": [
            {"tool": "alpha_predict", "role": "primary",
             "reason": "Multi-fidelity evaluation: physics + pretrained GNN models"},
        ],
...
def _keyword_tool_suggestions(query: str) -> list[dict]:
    ...
    keyword_map = {
        "alloy": ["alpha_predict", "search_materials"],
        "composition": ["alpha_predict"],
        "energy": ["alpha_predict"],
        "formation": ["alpha_predict"],
        "elastic": ["alpha_predict"],
        "modulus": ["alpha_predict"],
        "density": ["alpha_predict"],
        "stability": ["alpha_predict"],
        "search": ["search_materials", "query"],
        ...
        "battery": ["alpha_predict"],
        "catalyst": ["alpha_predict"],
    }
