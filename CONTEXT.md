...
NEXT: judge §11 (RHEA) when run 9 writes it; rebuild+send .docx; read tui_design_review.md (workflow wypl0cuwm) and rank the TUI changes; tool descriptions: supercells by cache_ref; 54 ms mpirun death unexplained; CALPHAD TDB; CONTEXT.md ≤20 lines at session end.
