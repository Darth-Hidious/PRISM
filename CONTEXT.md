...
NEXT: run 8 (scratch run8_prompt.txt) writes the MD numbers into §10.4; QE rerun addendum in §9.2 item 1 (maintainer rerun, attributed); rebuild+send .docx; read tui_design_review.md and rank the TUI changes; tool descriptions: supercells by cache_ref; 54 ms mpirun death unexplained; CALPHAD TDB; CONTEXT.md ≤20 lines at session end.
