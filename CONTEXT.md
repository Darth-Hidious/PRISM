...
NEXT: watch run 12b, approve its tools, merge section13_cluster_expansion.md into the review when it lands; TUI changes 8/9/10 + verify:7 (workflow died on session limit, resume wf_00c8db2b); deadline-fix commit still uncommitted (2 renamed assertions); novelty for 5 unassessed + verify the 10; CALPHAD TDB; PRISM pre-flight; CONTEXT.md ≤20 lines at end.
