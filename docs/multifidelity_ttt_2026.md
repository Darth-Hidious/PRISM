...
|---|---|
| Generative design (`crates/explore` GFlowNet sampler, marketplace-installable design plugins) | Step 1 of the loop — produce 500 candidate designs |
...
```
                ...
                ┌─────────────────────┐
                │ Generative Design   │
                │ GFlowNet + Flow     │   (existing: crates/explore + marketplace)
                │ Matching            │
                └──────────┬──────────┘
                           ↓
                ┌─────────────────────┐
