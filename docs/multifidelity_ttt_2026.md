...
|---|---|
| Generative design (`crates/explore` generative sampler, marketplace-installable design plugins) | Step 1 of the loop — produce 500 candidate designs |
...
```
                ...
                ┌─────────────────────┐
                │ Generative Design   │
                │ Generative Flow     │   (existing: crates/explore + marketplace)
                │ Matching            │
                └──────────┬──────────┘
                           ↓
                ┌─────────────────────┐
